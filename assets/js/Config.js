...
MIA.config.playlists = [
	...
	},
	{
		...
		songs : [
			{ filename : 'aty.mp3', name : 'A Thousand Years - Christina Perri', end_early : 10, volume : 0.5 },
		],
		notes : [
	...
	},
	{
		...
		notes : [
			'Click <button><i class="fa fa-play" /></button> at the end of the ceremony (after the officiant says \"Congratulations\").',
	...
	},
	{
		...
		songs : [
			...
			{ filename : 'ikywt.mp3', name : 'I Knew You Were Trouble - Taylor Swift'         , end_early :  4 },
			...
			{ filename :    'dq.mp3', name : 'Dancing Queen - ABBA'                           , end_early :  0 },
			...
			{ filename :   'igf.m4a', name : 'I Gotta Feeling - Black Eyed Peas'              , end_early :  2 },
			...
			{ filename :   'dls.mp3', name : 'Dirty Little Secret - All American Rejects'     , end_early :  8 },
